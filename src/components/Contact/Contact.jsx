        ...
        <form className="p-3 p-md-4  ">
            <div className="row">
                <div className="col-md-6 mb-3">
                    ...
                    <input type="text" className="form-control rounded-3 py-2" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Biswasmruti" />
                </div>
                <div className="col-md-6 mb-3">
                    <label htmlFor="exampleInputEmail1" className="form-label fw-semibold text-muted">EMAIL ADDRESS</label>
                    <input type="email" className="form-control rounded-3 py-2" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="BIswa@gmail.com" />
                </div>
            </div>
            <div className=" mb-3">
                <label htmlFor="exampleInputEmail1" className="form-label fw-semibold text-muted">PHONE NUMBER</label>
                <input type="tel" className="form-control rounded-3 py-2" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="+91 96575 44844" />
            </div>
            ...
            <button type="button" className="rounded-3 mt-3 contactSelect">Get Started Now</button>
